...
def create_llm(model_path = config["model_path"]["large"], model_type = config["model_type"], model_config=config['model_config']):
    # Ctransformers help to load the quantized models
...
class chatChain:
    ...
    # Using run method to stop the llm to provide random answers
    # ne drawback of using this method is we need to provide it with all the chat history
